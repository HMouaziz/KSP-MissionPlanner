...
const tools =  [
  ...
  },
  {
    title: "More Tools",
    href: "/tools",
    description: "Explore a complete list of our specialized space mission planning tools."
  }
]
  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Explore our comprehensive suite of space exploration tools, tailored for the modern astronautical engineer. From detailed mission planning and historical mission archives to extensive craft and launch complex repositories, each component is designed to optimize and streamline the complexities of space mission management.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
              <ListItem href="/missions" title="Missions">
                Advanced tools for meticulous mission planning, ensuring precise strategy formulation and execution in space exploration.
              </ListItem>
              <ListItem href="/crafts" title="Crafts">
                Explore and manage a detailed repository of spacecraft, each meticulously documented for assignment to future missions.
              </ListItem>
              <ListItem href="/launch" title="Launch Complexes">
                Organize and oversee launch complexes, ensuring they are optimized and ready for the diverse needs of various spacecraft launches.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <Link to='https://github.com/HMouaziz/KSP-MissionPlanner-Client'>
            GitHub
          </Link>
        </NavigationMenuItem>
        <NavigationMenuItem>
